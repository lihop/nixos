...

{
  ...
  users.extraGroups.${user.name}.gid = 1000;
  users.extraUsers.${user.name} = {
    isNormalUser = true;
    home = "/home/${user.name}";
    description = user.fullName;
    extraGroups = [ "lp" user.name "wheel" ];
    uid = 1000;
